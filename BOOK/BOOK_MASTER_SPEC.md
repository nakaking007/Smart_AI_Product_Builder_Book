...
Ribbon Navigation ใช้สีประจำ PART 1–8 ตาม `BOOK_ART_DIRECTION_STANDARD_v1.0.md` ส่วน Single Web App, Workshop/Capstone และ Appendix ใช้ Tab เสริมโดยห้ามตัดออก ภาพบุคคลต้องสะท้อนคนไทยและบริบทไทยร่วมสมัยอย่างถูกต้อง หลากหลาย และมีสิทธิ์ใช้งาน

ทุกบทต้องมี Layout Specification รายหน้า, Infographic อย่างน้อย 3 ชิ้น, Diagram Suite, Image Prompt Metadata และไฟล์ต้นฉบับ Diagram/Infographic ที่แก้ไขต่อได้ ห้ามมีหน้าข้อความล้วนเกิน 1 หน้าติดต่อกัน
